    ...
    <fooetr>
        <div class="footer">
            <div class="container-fluid">
                <div class="row">
                  <div class=" col-md-12">
                    <h2>Nhập Thông Tin  <strong class="white"> Bản Thân</strong></h2>
                  </div>
                        ...
                        <form class="main_form">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <input class="form-control" placeholder="Tên" type="text" name="ten">
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <input class="form-control" placeholder="Giới Tính" type="text" name="gioitinh"></input>
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <button name = "btntinh" class="send">Tính BMI</button>
                                </div>                            
